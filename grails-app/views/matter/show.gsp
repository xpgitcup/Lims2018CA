...
<html>
    ...
    <body>
        ...
        <div id="show-matter" class="content scaffold-show" role="main">
            ...
            <f:display bean="matter" />
            <g:form resource="${this.matter}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.matter}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
